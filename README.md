...
Clone and copy this repository to the `koreader/plugins/stopwatchtimer.koplugin` folder.
...
Or use the toggle button to switch between the stopwatch and the timer.
